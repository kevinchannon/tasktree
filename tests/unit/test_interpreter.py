...
class TestInterpreterConstruction(unittest.TestCase):
    ...
    def test_default_invocation_cmd_is_empty_list(self):
...
class TestInterpreterLookup(unittest.TestCase):
    ...
    def test_all_invocation_cmds_are_non_empty_lists(self):
        for name, interp in INTERPRETER_LOOKUP.items():
            with self.subTest(name=name):
                self.assertIsInstance(interp.invocation_cmd, list)
    ...
    def test_unix_shells_have_sh_extension(self):
...
class TestInterpreterFromName(unittest.TestCase):
    """Test Interpreter.from_name() class method."""
...
class TestInterpreterDefaults(unittest.TestCase):
    """Test host_default() and container_default() class methods."""
