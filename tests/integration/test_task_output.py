...
""")
    ...
    def test_task_output_none_suppresses_output(self):
        """
        Test that --task-output=none suppresses task subprocess output.
        """
        with TemporaryDirectory() as tmpdir:
            project_root = Path(tmpdir)
...
""")
            ...
            try:
                ...
                # Task completion message should still appear
