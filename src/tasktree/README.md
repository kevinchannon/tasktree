...
Task Tree includes a [JSON Schema](https://github.com/kevinchannon/tasktree/blob/main/schema/tasktree-schema.json) that provides autocomplete, validation, and documentation in modern editors.
...
# Result: User's zsh runner is used (highest precedence)
```
